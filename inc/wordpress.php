 ...
 */
function sarika_enqueue_lightbox() {
...
add_action( 'wp_enqueue_scripts', 'sarika_enqueue_lightbox' );
 ...
 */
function sarika_gallery_lightbox( $block_content, $block ) {
...
add_filter( 'render_block', 'sarika_gallery_lightbox', 10, 2 );
