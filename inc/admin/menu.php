 ...
 */
function sarika_admin_menu_scripts() {
	wp_enqueue_script(
		'sarika-admin-menu',
		SARIKA_URI . '/js/admin-menu.js',
		array(),
		SARIKA_VERSION,
		true
	);
}
add_action( 'admin_enqueue_scripts', 'sarika_admin_menu_scripts' );
 ...
 */
function sarika_custom_menu_order( $menu_order ) {
	if ( ! $menu_order ) {
		return true;
	}
	...
	return array(
		'index.php',                   // Dashboard.
		'sarika-dashboard',           // Custom Dashboard (if using).
...
// add_filter( 'menu_order', 'sarika_custom_menu_order' );
 ...
 */
function sarika_remove_admin_menus() {
...
add_action( 'admin_menu', 'sarika_remove_admin_menus', 999 );
 ...
 */
function sarika_admin_body_class( $classes ) {
...
add_filter( 'admin_body_class', 'sarika_admin_body_class' );
 ...
 */
function sarika_custom_menu_icon( $icon_data, $icon_file, $menu_id ) {
...
// add_filter( 'wp_menu_image', 'sarika_custom_menu_icon', 10, 3 );
