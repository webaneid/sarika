...
/**
 * Register Sarika Posts Widget.
 */
function sarika_posts_widget_init() {
	register_widget( 'Sarika_Posts_Widget' );
}
add_action( 'widgets_init', 'sarika_posts_widget_init' );

/**
 * Sarika Posts Widget Class.
 */
class Sarika_Posts_Widget extends WP_Widget {
	/**
	 * Constructor.
	 */
	public function __construct() {
		parent::__construct(
			'sarika-post-widget',
			__( 'Sarika: Posts', 'sarika' ),
			array(
				'description' => __( 'Display posts by recent, category, tag, or most commented. Fully customizable.', 'sarika' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( 'Most Comments' === $type ) {
			...
			$query_args['meta_key'] = 'sarika_views';
		...
		if ( $r->have_posts() ) {
			...
			echo '<p class="widget-no-posts">' . esc_html__( 'No posts found.', 'sarika' ) . '</p>';
		}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
				<?php esc_html_e( 'Widget Title', 'sarika' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>">
				<?php esc_html_e( 'Select Type', 'sarika' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'post_tag' ) ); ?>">
				<?php esc_html_e( 'Tag (separate by comma)', 'sarika' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
				<?php esc_html_e( 'Number of posts to show', 'sarika' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'orderby' ) ); ?>">
				<?php esc_html_e( 'Order By', 'sarika' ); ?>
			</label>
