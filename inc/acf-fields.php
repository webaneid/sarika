	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				...
				array(
					'key'               => 'field_ane_show_breadcrumb',
					'label'             => 'Show Breadcrumb',
					'name'              => 'ane_show_breadcrumb',
					'type'              => 'true_false',
					'instructions'      => 'Display breadcrumb navigation above page title.',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
				...
				array(
					'key'               => 'field_ane_show_title',
					'label'             => 'Show Page Title',
					'name'              => 'ane_show_title',
					'type'              => 'true_false',
					'instructions'      => 'Display page title in header section (will use page title from WordPress).',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
				...
				array(
					'key'               => 'field_ane_show_description',
					'label'             => 'Show Description',
					'name'              => 'ane_show_description',
					'type'              => 'true_false',
					'instructions'      => 'Enable to show custom description below title.',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
				...
				array(
					'key'               => 'field_ane_page_description',
					'label'             => 'Page Description',
					'name'              => 'ane_page_description',
					'type'              => 'textarea',
					'instructions'      => 'Enter custom description (supports HTML). This will appear in right column on desktop.',
					'required'          => 0,
					'conditional_logic' => array(
						array(
							array(
								'field'    => 'field_ane_show_description',
								'operator' => '==',
								'value'    => '1',
							),
						),
				...
				array(
					'key'               => 'field_ane_show_featured_image',
					'label'             => 'Show Featured Image',
					'name'              => 'ane_show_featured_image',
					'type'              => 'true_false',
					'instructions'      => 'Display featured image below title/description section.',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
