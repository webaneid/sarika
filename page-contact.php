...
$company = sarika_get_about_company_data();
$company_name = sarika_get_company_display_name();

// Get contact page content from ACF options
$contact_group = sarika_get_option_group( 'ane_page_contact' );
				...
				<div class="contact-page__info-wrapper">
					...
					<?php if ( $contact['email'] ) : ?>
						<div class="contact-info__card">
							<h2 class="contact-info__title"><?php esc_html_e( 'Email Support', 'sarika' ); ?></h2>
							<p class="contact-info__description">
								<?php esc_html_e( 'Interested in trying it? speak to our team.', 'sarika' ); ?>
							</p>
					...
					<?php if ( $contact['phone'] ) : ?>
						<div class="contact-info__card">
							<h2 class="contact-info__title"><?php esc_html_e( 'Call Us', 'sarika' ); ?></h2>
							<p class="contact-info__description">
								<?php esc_html_e( 'Give us a call for immediate assistance.', 'sarika' ); ?>
							</p>
					...
					<?php if ( $contact['address'] ) : ?>
						<div class="contact-info__card">
							...
							<p class="contact-info__hours">
								<?php esc_html_e( 'Visit our office Mon - Fri, 08:00 AM - 05:00PM', 'sarika' ); ?>
							</p>
