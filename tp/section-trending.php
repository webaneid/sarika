...
// Get trending posts.
$trending_query = sarika_get_trending_posts( $trending_limit );
	...
	<div class="section-trending__grid">
		...
		<div class="section-trending__content">
			<h2 class="section-trending__title">
				<?php esc_html_e( 'Recommended for You', 'sarika' ); ?>
			</h2>
		...
		<aside class="section-trending__sidebar">
			<h3 class="section-trending__sidebar-title">
				<?php esc_html_e( 'Trending Topics', 'sarika' ); ?>
			</h3>

			<?php
			$trending_tags = sarika_get_trending_tags( 10 );
