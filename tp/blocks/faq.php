								...
								if ( $desktop_url && $mobile_url ) {
									...
									<picture>
										...
										<img
											...
											class="sarika-faq__image"
											loading="lazy"
										>
									</picture>
									<?php
								} else {
									echo '<img src="' . esc_url( $image ) . '" alt="' . esc_attr( $image_alt ?: $image_title ) . '" class="sarika-faq__image" loading="lazy">';
								}
							} else {
								echo '<img src="' . esc_url( $image ) . '" alt="" class="sarika-faq__image" loading="lazy">';
							}
							?>
						</div>
					<?php endif; ?>
