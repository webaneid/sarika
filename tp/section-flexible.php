	...
	<div class="container">
		<div class="grid lg:grid-cols-2fr-1fr gap-8 lg:divide-x divide-gray-200">
				...
				if ( $has_flexible ) :
					...
					<div class="p-6 bg-gray-100 rounded-lg text-center">
						<p class="text-sm text-gray-600">
							<?php esc_html_e( 'No flexible content. Add layouts from ACF on this page.', 'sarika' ); ?>
						</p>
					</div>
					<?php
				endif;
			...
			<aside class="sidebar lg:pl-8">
				<?php
				if ( is_active_sidebar( 'sidebar-page-news' ) ) :
					dynamic_sidebar( 'sidebar-page-news' );
				else :
					?>
					<div class="sidebar-placeholder p-6 bg-gray-100 rounded-lg text-center">
						<p class="text-sm text-gray-600">
							<?php esc_html_e( 'Add widgets for Page News Sidebar in WP Admin → Appearance → Widgets.', 'sarika' ); ?>
						</p>
					</div>
					<?php
				endif;
