...
(function() {
	...
	document.addEventListener('DOMContentLoaded', function() {
		if (typeof Chart === 'undefined' || typeof sarikaDashboard === 'undefined') {
			return;
		}

		const chartCanvas = document.getElementById('sarika-posts-chart');
		if (!chartCanvas) {
			return;
		}

		const data = sarikaDashboard.postsData;
		const colors = sarikaDashboard.colors;
