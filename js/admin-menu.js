			...
			if (link) {
				...
				link.addEventListener('click', function(e) {
					...
					if (isOpen) {
						...
						item.setAttribute('data-sarika-locked', 'false');
						activeItem = null;
						...
						menuItems.forEach(function(otherItem) {
							...
							otherItem.setAttribute('data-sarika-locked', 'false');
						});

						item.classList.add('opensub');
						item.setAttribute('data-sarika-locked', 'true');
						activeItem = item;
				...
				const observer = new MutationObserver(function(mutations) {
					mutations.forEach(function(mutation) {
						if (mutation.type === 'attributes' && mutation.attributeName === 'class') {
							const isLocked = item.getAttribute('data-sarika-locked') === 'true';
